...
public class AddonShovelItem extends ShovelItem implements IAddonItem {
    ...
    public AddonShovelItem(Tier tier, int baseDamage, float attackSpeed, Properties properties) {
    ...
    public static class Parser implements ItemParser.ItemTypeSerializer {
        ...
        public IAddonItem parse(JsonObject json, Properties properties) {
            ...
            return new AddonShovelItem(tier, GsonHelper.getAsInt(json, "base_damage"), GsonHelper.getAsFloat(json, "attack_speed"), properties);
        }

        @Override
        public void generateDocumentation(JsonDocumentationBuilder builder) {
            builder.setTitle("Shovel");
            ...
            builder.addProperty("base_damage", Integer.class)
                    .description("Base value for the damage. For reference: shovels usually have 1.5")
                    .required().exampleJson(new JsonPrimitive(1.5F));

            builder.addProperty("attack_speed", Float.class)
                    .description("Base value for the attack speed. For reference: shovels usually have -3.0")
